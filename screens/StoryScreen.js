...
export default class StoryScreen extends Component {
  ...
  speakText = async(title, author, story, moral) => {
      let currentColor = this.state.speakerColor;
      let changeColor = currentColor === 'gray' ? 'red' : 'gray';
      this.setState({speakerColor: changeColor})
